...
const CalculatePage = () => {
  ...
  return (
    <div className="flex flex-col w-[500px] max-w-[90%] h-[668px] max-h-[90%] border-[1px] rounded-lg overflow-hidden absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] overflow-y-auto scrollbar-hide p-[20px] gap-[10px]">
